...
class SvdMatrix:
    ...
    """
    def __init__(self, nusers, nmovies, r=30, lrate=0.11, regularizer=0.025):
...
if __name__ == "__main__":
    ...
    with open('submission/SVD_globalEffect_maxepochs10_minimprov0,0005_regularizer0.05_lrate0,08_r30.csv', 'w', newline='') as f:
        my_dict = {}
        rankings = []
